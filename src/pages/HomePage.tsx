          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <a
                ...
                className="inline-flex items-center space-x-reverse space-x-3 bg-emerald-700 hover:bg-emerald-800 text-white px-8 py-4 rounded-lg text-lg font-bold transition-all duration-300 hover:scale-105 shadow-lg"
              >
                <span>📱</span>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-emerald-700 text-white p-4 rounded-xl shadow-lg">
                <p className="text-sm font-bold">{t.instantAppraisal}</p>
                <p className="text-xs font-medium">{t.inJeddah}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
              <p className="mb-4">
                {t.servicesPara1} <strong className="text-emerald-800">{t.servicesHighlight1}</strong> {t.servicesHighlight1End}
              </p>
              <p className="mb-4">
                {t.servicesPara2Start} <strong className="text-emerald-800">{t.servicesPara2Highlight}</strong> {t.servicesPara2End}
              </p>
              <p>
                {t.servicesPara3Start} <strong className="text-emerald-800">{t.servicesPara3Highlight}</strong> {t.servicesPara3End}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-emerald-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center space-x-reverse space-x-3 bg-white text-emerald-800 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg"
          >
            <span>📱</span>
            <span>{t.heroButton}</span>
          </a>
