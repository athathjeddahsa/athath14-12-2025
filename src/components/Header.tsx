        ...
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden flex items-center gap-2">
            <div className="flex gap-1">
              <button
                onClick={() => setLanguage('ar')}
                className={`px-2 py-1 text-xs rounded font-medium ${language === 'ar' ? 'bg-emerald-200 text-emerald-800' : 'text-gray-700'}`}
              >
                AR
              </button>
              <button
                onClick={() => setLanguage('en')}
                className={`px-2 py-1 text-xs rounded font-medium ${language === 'en' ? 'bg-emerald-200 text-emerald-800' : 'text-gray-700'}`}
              >
                EN
              </button>
            </div>
